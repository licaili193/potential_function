...
void MainFrame::do_layout() {
  ...
  wxStaticBoxSizer* sizer_1 =
      new wxStaticBoxSizer(sizer_1_staticbox, wxVERTICAL);
...
void MainFrame::OnTimerTimeout(wxTimerEvent& event) { CmdPhraser(&Msg); }
...
bool GraphTestApp::OnInit() {
  ...
  MainFrame* mainFrame = new MainFrame(NULL, wxID_ANY, wxEmptyString,
